...
# Créer la page d'accueil avec module
echo '<h1>Server ${server_number} - Feature: ${feature_name} (${workspace})</h1>' > /var/www/html/index.html
echo '<p>Instance ID: ${instance_id}</p>' >> /var/www/html/index.html
echo '<p>Module webserver avec user-data</p>' >> /var/www/html/index.html

echo "Configuration serveur ${server_number} (module) terminée avec user-data"