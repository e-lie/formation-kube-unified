...
description: Guide complet pour apprendre Kubernetes
template: splash
hero:
  tagline: Apprenez Kubernetes de zéro avec des exercices pratiques !
  image:
    alt: Terraform
    file: ../../assets/houston.webp
  actions:
    - text: Commencer la formation
      link: /kubernetes-principal/000-cours-intro/
      icon: right-arrow
      variant: primary
    - text: Voir sur GitHub
      link: https://github.com/e-lie/formation-kube-unified
      icon: external
      variant: minimal
---
