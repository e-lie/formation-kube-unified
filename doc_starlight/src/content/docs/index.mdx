...
hero:
  ...
  actions:
    - text: Commencer la formation
      link: /formation-terraform-unified/guides/100-simple-aws-server/
      icon: right-arrow
      variant: primary
    - text: Voir sur GitHub
      link: https://github.com/e-lie/formation-terraform-unified.git
      icon: external
      variant: minimal
---
...
**Prêt à commencer ?** [Lancez-vous avec le TP1 →](/formation-terraform-unified/guides/100-simple-aws-server/)