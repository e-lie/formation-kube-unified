...
# Créer la page d'accueil avec Terragrunt
echo '<h1>Server ${server_number} - Feature: ${feature_name} (${workspace})</h1>' > /var/www/html/index.html
echo '<p>Instance ID: ${instance_id}</p>' >> /var/www/html/index.html
echo '<p>Terragrunt avec user-data</p>' >> /var/www/html/index.html

echo "Configuration serveur ${server_number} (Terragrunt) terminée avec user-data"