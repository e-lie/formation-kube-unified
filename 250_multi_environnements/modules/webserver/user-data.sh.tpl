...
# Créer la page d'accueil multi-environnements
echo '<h1>Server ${server_number} - Feature: ${feature_name} (${workspace})</h1>' > /var/www/html/index.html
echo '<p>Instance ID: ${instance_id}</p>' >> /var/www/html/index.html
echo '<p>Multi-environnements avec user-data</p>' >> /var/www/html/index.html

echo "Configuration serveur ${server_number} (multi-env) terminée avec user-data"