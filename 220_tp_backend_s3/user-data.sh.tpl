...
# Créer la page d'accueil avec backend S3
echo '<h1>Feature: ${feature_name} (${workspace})</h1>' > /var/www/html/index.html
echo '<p>Backend S3 avec user-data</p>' >> /var/www/html/index.html

echo "Configuration terminée avec user-data et backend S3"